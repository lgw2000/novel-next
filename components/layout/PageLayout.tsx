...
export function PageLayout({
  ...
  const { setOnClose, setCompactOnMobile } = useSidebarContext();

  useEffect(() => {
    setOnClose(() => closeSidebar);
    setCompactOnMobile(!!compactSidebarOnMobile);
  }, [closeSidebar, compactSidebarOnMobile, setOnClose, setCompactOnMobile]);
